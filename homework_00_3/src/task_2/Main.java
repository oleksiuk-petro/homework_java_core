...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        switch (number){
            case 1: day="Monday - swimming!";break;
            case 2: day="Tuesday - running!";break;
            case 3: day="Wednesday - jumping!";break;
            case 4: day="Thursday - cycling!";break;
            case 5: day="Friday - climbing!";break;
            case 6: day="Saturday - cleaning!";break;
            case 7: day="Sunday - vacation!";break;
            default: day="It is wrong number day!";
        }
