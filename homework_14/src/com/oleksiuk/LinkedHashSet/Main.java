 ...
 */
package com.oleksiuk.LinkedHashSet;
...
public class Main {
    public static void main(String[] args) {
        ...
        //викликаємо метод сортування використовуючи LinkedHashSet
        sortUsingLinkedHashSet(car);
    }
    ...
    //метод сортування використовуючи LinkedHashSet
    public static void sortUsingLinkedHashSet(Set<Car> car) {
        System.out.println("Виконуємо, використовуючи LinkedHashSet.");
