 ...
 * 8) Виводимо і-тий елемент колекції (який ми вводимо з консолі (використовуємо Scanner))
...
public class Main {
    ...
    //метод для оператора з багатьма розгалуженнями
    public static void methodForSwitch(List<Commodity> subject) {
        ...
        switch (n) {
            ...
            case 4: {
                ...
                Collections.sort(subject, comparatorName);
                //викликаємо метод, який виводить колекцію на екран
                printCollection(subject);
            }
            break;
            case 5: {
                ...
                Collections.sort(subject, comparatorWeight);
                //викликаємо метод, який виводить колекцію на екран
                printCollection(subject);
            }
            break;
            case 6: {
                ...
                Collections.sort(subject, comparatorLength);
                //викликаємо метод, який виводить колекцію на екран
                printCollection(subject);
            }
            break;
            case 7: {
                //сортуємо колекцію за шириною товару
                ComparatorWidth comparatorWidth = new ComparatorWidth();
                Collections.sort(subject, comparatorWidth);
                //викликаємо метод, який виводить колекцію на екран
                printCollection(subject);
            }
            break;
